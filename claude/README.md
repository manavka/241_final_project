...
**Dependent variables measured per round:**
- Time engaged (active seconds, paused time excluded)
- Solve rate and first-attempt accuracy
- Attempt count and time to first attempt
- Skip/quit rate
- Rage-click events and rapid-guess events
- Tab-switch count and duration
